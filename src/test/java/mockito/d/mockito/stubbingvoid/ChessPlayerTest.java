...
class ChessPlayerTest {
    ...
    // example test on getWins() and getPoints() methods
    // stubbing assignScoreStats() method's behavior with doAnswer()
    @Test
    ...
    // write a test on getCategory() method for "path b" using a "spy"
    @Test
    ...
    // write a test on getCategory() method for "path b" using a "mock"
    @Test
    ...
    // write a test on assignCategory() method for "path a" on a "spy"
    // stubbing assignCategory() with doThrow()
    @Test
