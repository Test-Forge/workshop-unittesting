...
public class Parking {
    ...
    public int getTotalAvailableSpaces() {
        return (MOTORCYCLE_PARKING_CAPACITY - getParkedVehiclesByType(Vehicle.VehicleType.MOTORCYCLE))
                + (PASSENGER_CARS_PARKING_CAPACITY - getParkedVehiclesByType(Vehicle.VehicleType.PASSENGER_CAR))
                + (SUV_PARKING_CAPACITY - getParkedVehiclesByType(Vehicle.VehicleType.SUV))
                + (COMMERCIAL_PARKING_CAPACITY - getParkedVehiclesByType(Vehicle.VehicleType.COMMERCIAL));
    }
}
